...
<body class="leading-normal tracking-normal text-white gradient" style="font-family: 'Source Sans Pro', sans-serif;">
    ...
    <section class=" bg-gray-50">
        <div class="container px-6 py-10 mx-auto">
            <h1 class="text-3xl font-semibold  capitalize lg:text-4xl text-black">explore our <br>
                awesome <span class="underline decoration-blue-500">Components</span></h1>

            <p class="mt-4  xl:mt-6 text-gray-800">
            ...
            <div class="grid grid-cols-1 gap-8 mt-8 xl:mt-12 xl:gap-12 md:grid-cols-2 xl:grid-cols-3">
                <div class="p-8 space-y-3 border-2  border-blue-300 rounded-xl">
                    ...
                    <h1 class="text-2xl font-semibold  capitalize text-black">elegant Mode</h1>
                ...
                <div class="p-8 space-y-3 border-2  border-blue-300 rounded-xl">
                    ...
                    <h1 class="text-2xl font-semibold  capitalize text-black">Easy to customiztions
                    </h1>
                ...
                <div class="p-8 space-y-3 border-2  border-blue-300 rounded-xl">
                    ...
                    <h1 class="text-2xl font-semibold  capitalize text-black">Simple & clean designs
                    </h1>
