    ...
    <div class="relative min-h-screen flex ">
        <div
            ...
            <div class="sm:w-1/2 xl:w-3/5 h-full hidden md:flex flex-auto items-center justify-center p-10 overflow-hidden bg-red-900 text-white bg-no-repeat bg-cover relative"
                style="background-image: url(https://images.unsplash.com/photo-1590073242678-70ee3fc28e8e?ixlib=rb-1.2.1&ixid=MnwxMjA3fDF8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2021&q=80);">
                ...
                <div class="w-full  max-w-md z-10">
                    ...
                    <div class="sm:text-sm xl:text-md text-gray-200 font-normal">We give you a legendary welcome, every
                        time you come back. Come, stay and enjoy your day.
                    </div>
                </div>
                <!---remove custom style-->
                <ul class="circles">
