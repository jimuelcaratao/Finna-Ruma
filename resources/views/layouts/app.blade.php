    ...
    <div class="app-container">
        ...
        <div class="app-content">
            ...
            <div class="app-sidebar">
                <a href="{{ route('admin.dashboard') }}" data-tooltip-target="tooltip-dashboard"
                    data-tooltip-placement="right"
                    class="app-sidebar-link {{ request()->is('admin/dashboard') ? 'active' : '' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                ...
                <a href="{{ route('admin.users') }}" data-tooltip-target="tooltip-users"
                    data-tooltip-placement="right"
                    class="app-sidebar-link {{ request()->is('admin/users') ? 'active' : '' }}">
                ...
                <a href="{{ route('admin.categories') }}" data-tooltip-target="tooltip-categories"
                    data-tooltip-placement="right"
                    class="app-sidebar-link {{ request()->is('admin/categories') ? 'active' : '' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24"
                        stroke="currentColor" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <a href="{{ route('admin.rentals') }}" data-tooltip-target="tooltip-rentals"
                    data-tooltip-placement="right"
                    class="app-sidebar-link {{ request()->is('admin/rentals') ? 'active' : '' }}">
